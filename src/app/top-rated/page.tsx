    ...
    <div className="min-h-screen bg-black">
      ...
      <main className="px-4 md:px-6 py-8">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-3">Top Rated Shows</h1>
          <p className="text-gray-300 mb-6">Highest rated TV shows by the community.</p>
